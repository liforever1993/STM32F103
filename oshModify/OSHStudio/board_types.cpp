...
void OSHStudio::showBoardType(int boardtype)
{
    const struct pin_comp_geometry pin_components[3][32] =
    {
        ...
        {
            {"label_A0",550,280,"comboBoxA0",400,280},
            {"label_A1",550,260,"comboBoxA1",400,260},
            {"label_A2",550,240,"comboBoxA2",400,240},
            {"label_A3",550,220,"comboBoxA3",400,220},
            {"label_A4",550,200,"comboBoxA4",400,200},
            {"label_A5",550,180,"comboBoxA5",400,180},
            {"label_A6",550,160,"comboBoxA6",400,160},
            {"label_A7",550,140,"comboBoxA7",400,140},
            ...
            {"label_B0",550,120,"comboBoxB0",400,120},
            {"label_B1",550,100,"comboBoxB1",400,100},
            ...
            {"label_B10",550,80,"comboBoxB10",400,80},
            {"label_B11",550,60,"comboBoxB11",400,60},
    ...
    for (uint8_t i=0; i<32; i++){
        QComboBox *comboBox_ptr = ui->tabWidget->findChild<QComboBox *>(pin_components[0][i].ComboBox_name);
    ...
    {
        case 0:
            ui->label->setPixmap(QPixmap(":/Images/MDB_pic.jpg"));
            break;
        case 1:
            ui->label_C14->setVisible(false);
